...
SEQ_ORDERS[1]="5 6 7"           # v1 brute force: very slow
SEQ_ORDERS[2]="6 7 8"           # v2 backtracking
SEQ_ORDERS[3]="7 8 9"           # v3 branch & bound
SEQ_ORDERS[4]="8 9 10 11"       # v4 optimized
SEQ_ORDERS[5]="10 11 12 13"     # v5 production
SEQ_ORDERS[6]="11 12 13 14"     # v6 hardware optimized

# MPI versions: orders adapted to parallel scaling
declare -A MPI_ORDERS
MPI_ORDERS[1]="9 10 11"         # MPI v1 basic master/worker
MPI_ORDERS[2]="9 10 11"         # MPI v2 hypercube
MPI_ORDERS[3]="10 11 12 13 14"  # MPI v3 optimized with load balancing

# Versions with native CSV support
CSV_SEQ_VERSIONS=(5 6)
CSV_MPI_VERSIONS=(3)

# Process and thread counts
MPI_PROCS=(8 16 32 64 128)                      # Number of MPI processes to test
OMP_THREADS=(1 4 8 16)                          # OpenMP thread counts for v6
